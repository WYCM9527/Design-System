...
<template>
  ...
  <el-card class="flat" shadow="always">
    ...
    <el-table :data="members" style="width: 100%">
      ...
      <el-table-column label="操作" width="230" fixed="right" class-name="nowrap"><template #default="{ row }"><a class="act" @click="editRole(row)">编辑角色</a> · <a class="act">重置密码</a> · <a class="act danger" @click="remove(row)">移除</a></template></el-table-column>
    </el-table>
  </el-card>
