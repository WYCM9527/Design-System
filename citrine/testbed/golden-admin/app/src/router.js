...
const routes = [
  { path: '/login', component: () => import('./pages/Login.vue'), meta: { title: '登录', bare: true } },
  {
    ...
    children: [
      ...
      { path: 'merchants/:id', name: 'merchant-detail', component: () => import('./pages/MerchantDetail.vue'), meta: { title: '商户详情', menu: 'merchants', crumbs: ['业务', '商户管理'] } },
      ...
      { path: 'kitchen', name: 'kitchen', component: () => import('@wycm9527/citrine/vue/KitchenSink.vue'), meta: { title: '组件走查', crumbs: ['系统'] } },
